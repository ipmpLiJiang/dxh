...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<FebsResult> handleParamsInvalidException(FebsException e) {
        log.error(e.getMessage(), e);
        FebsResult result = new FebsResult(e);
        return new ResponseEntity<FebsResult>(result, e.getStatusCode());
    }
