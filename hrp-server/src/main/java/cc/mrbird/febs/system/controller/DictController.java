...
public class DictController extends BaseController {
    ...
    public List<Dict> getFieldDict(String tableName, String fieldName) {
        return dictService.getFieldDict(tableName, fieldName);
    }

    @GetMapping("/getDictMap/{deptid}")
    public Map<String,Object>getDictMap(@PathVariable(value = "deptid") String deptid){
        return dictService.getDictMap(deptid);
    }
