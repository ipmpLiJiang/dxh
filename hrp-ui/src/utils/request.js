...
moment.locale('zh-cn')
export const baseURL= 'http://10.250.11.92:8077/'
// export const baseURL = 'http://localhost:8088/'
// baseURL: 'http://10.250.11.92:8077/', // 医院服务器地址
// baseURL: 'http://10.250.11.92:8099/', // 医院服务器测试地址
// baseURL: 'http://qiuhongfei2.ngrok2.xiaomiqiu.cn/', // 外网穿透
// baseURL: 'http://129.211.4.36:1099/', // 云服务器地址
// 统一配置
let FEBS_REQUEST = axios.create({
  baseURL: baseURL, // 外网穿透
  responseType: 'json',
